                ...
                if (!context.products.Any())
                {
                    ...
                    var pro = new List<Product>
                    {
                            ...
                            new Product
                        {
                            ...
                            Description="Samsung Galaxy Note10 Lite smartphone har en ikonisk S Pen och vacker modern design med Infinity-O peksk�rm och h�llbar 3D Glasstic-baksida i kombinerad glas och plast.6.7 FHD+ Super AMOLED peksk�rm 12+12+12Mpx bakre trippelkamera S Pen",
                            Price = 549,
                            Category=cat_tablet,
